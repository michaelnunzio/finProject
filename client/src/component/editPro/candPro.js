        ...
        <div className='outter'>
                ...
                <div className="container"> 
                    ...
                    <form className="form-signin" method="post" action="/allcands">
                        ...
                        <input readOnly={this.state.readOnly} type="text" placeholder='Last 2 Employers or Projects' name="Project" id="inputProject" className="form-control" defaultValue={this.state.lastTwo} autoFocus/>
